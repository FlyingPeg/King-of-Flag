...
namespace Chess
{
    public class Chess
    {
        ...
        public Chess(UIBoard ui, int nPlayers = 1, bool setupBoard = true)
        {
            // callback setup
            this.m_UI = ui;
            this.m_UI.SetStatus("Generating...");
        ...
        private void switchPlayer()
        {
            ...
            this.m_UI.SetStatus(((this.Turn == Player.WHITE) ? "White" : "Black") + "'s Turn.");
        ...
        public bool detectCheckmate()
        {
            ...
            if (!LegalMoveSet.hasMoves(this.Board, this.Turn))
            {
                if (LegalMoveSet.isCheck(this.Board, this.Turn))
                {
                    ...
                    this.m_UI.SetStatus(((this.Turn == Player.WHITE) ? "Black" : "White") + " wins!");
                }
                else
                {
